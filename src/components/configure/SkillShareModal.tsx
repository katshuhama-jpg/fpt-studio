 ...
 * ShareKnowledgeBaseModal so the two modules' sharing UI never drifts. */
    ...
    <>
      <Dialog open={open} onOpenChange={v => !v && onClose()}>
        <DialogContent className="sm:max-w-[520px]" onOpenAutoFocus={e => e.preventDefault()}>
          <DialogHeader>
            <DialogTitle>Chia sẻ skill</DialogTitle>
                    ...
                    <div key={opt.value}>
                      ...
                      {selected && opt.value === "specific" && (
                        <div className="mt-2 pl-3.5">
                          <SkillMemberPicker value={people} onChange={setPeople} ownerRow={{ name: ownerName, email: "" }} />
      ...
      <AlertDialog open={showRevokeConfirm} onOpenChange={setShowRevokeConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>{revokedCount} người sẽ không còn dùng được skill này.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
