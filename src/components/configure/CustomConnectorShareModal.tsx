...
import { type Sharing, type SharingMode } from "./customConnectorSharing";
...
/** "Chia sẻ" modal for a Custom Connector's row "..." menu — owner-only, lets them add/remove
 * people or change the sharing mode after creation. Field-for-field port of
                    ...
                    <div key={opt.value}>
                      ...
                      {selected && opt.value === "specific" && (
                        <div className="mt-2 pl-3.5">
                          <CustomConnectorMemberPicker value={people} onChange={setPeople} ownerRow={{ name: ownerName, email: "" }} />
