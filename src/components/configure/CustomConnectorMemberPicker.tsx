...
import type { SharedPerson, SharingAccess } from "./customConnectorSharing";
...
/** "Người dùng cụ thể" picker for Custom Connectors — search+chip console-member picker with a
 * per-person "Có thể xem"/"Có thể chỉnh sửa" access dropdown. Field-for-field port of
 * GuardrailMemberPicker.tsx / Knowledge's MemberPicker.tsx so the sharing UI never drifts across
 * modules, without cross-importing between feature folders. */
export default function CustomConnectorMemberPicker({
