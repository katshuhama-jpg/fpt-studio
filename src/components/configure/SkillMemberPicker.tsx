...
/** "Người dùng cụ thể" picker for Skills — field-for-field port of Knowledge's MemberPicker so
 * the two modules' sharing UI never drifts, without cross-importing between the Knowledge and
 * Skills feature folders. */
export default function SkillMemberPicker({
