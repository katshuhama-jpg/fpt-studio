  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${selected ? "var(--wf-omni)" : hovered ? "var(--wf-border-hover)" : "var(--wf-border)"}`,
        boxShadow: selected ? "0 0 0 2px var(--wf-omni-bg)" : hovered ? "var(--wf-node-shadow-hover)" : "var(--wf-node-shadow)",
      }}
    >
