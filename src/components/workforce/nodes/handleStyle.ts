...
export const HANDLE_CLASS =
  "!w-3.5 !h-3.5 !bg-primary !border-2 !border-white !rounded-full !cursor-crosshair !shadow-sm transition-transform duration-150 hover:!scale-125 focus-visible:!outline-none focus-visible:!ring-2 focus-visible:!ring-ring before:content-[''] before:absolute before:-inset-[15px] before:rounded-full";
