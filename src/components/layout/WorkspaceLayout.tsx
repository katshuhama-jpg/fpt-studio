...
export default function WorkspaceLayout() {
  ...
  const ORG_BREADCRUMB_LABELS: Record<string, string> = { "": "General", structure: "Structure", workspaces: "Workspaces", permissions: "Permissions", roles: "Roles" };
